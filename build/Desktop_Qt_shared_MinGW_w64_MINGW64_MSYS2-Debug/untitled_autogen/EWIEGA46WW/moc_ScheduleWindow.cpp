...
struct qt_meta_stringdata_CLASSScheduleWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSScheduleWindowENDCLASS = QtMocHelpers::stringData(
    "ScheduleWindow",
    "onCellPressed",
    "",
    "row",
    "column",
    "onMenuCloseTriggered",
    "onBackButtonClicked",
    "saveDataToJson",
    "loadDataFromJson",
    "closeEvent",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSScheduleWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ScheduleWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSScheduleWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSScheduleWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSScheduleWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        ...
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'onMenuCloseTriggered'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onBackButtonClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'saveDataToJson'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void ScheduleWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onCellPressed((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->onMenuCloseTriggered(); break;
        case 2: _t->onBackButtonClicked(); break;
        case 3: _t->saveDataToJson(); break;
        case 4: _t->loadDataFromJson(); break;
...
void *ScheduleWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSScheduleWindowENDCLASS.stringdata0))
